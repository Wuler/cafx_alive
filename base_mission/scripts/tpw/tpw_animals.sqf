...
tpw_animal_max = (paramsarray select 47); // maximum animals near player
...
if (isMultiplayer) then
	{
	tpw_animal_sleep = 10;
	tpw_animal_max = (paramsarray select 47);
