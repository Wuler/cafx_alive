...
killedText = {
	...
	<img color='#ffffff' image='scripts\cacheScript\Images\img_line_ca.paa' align='left' size='0.79' />
	<t color='#eaeaea'>%1/6</t><t color='#80FF00'> Ammo Caches</t><t color='#eaeaea'> have been destroyed</t>
	<img color='#ffffff' image='scripts\cacheScript\Images\img_line_ca.paa' align='left' size='0.79' />", INS_west_score]
};
