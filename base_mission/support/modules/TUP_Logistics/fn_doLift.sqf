...
_placeholder = "Land_HelipadEmpty_F" createVehicle _droppos;
...
_Transporter FlyInHeight 11;
_wp setWaypointSpeed "LIMITED";
_wp setWaypointBehaviour "CARELESS";

// If Container, then add items to container using R3F else apply object
If ((typeof _obj in ["Land_Cargo20_military_green_F"]) || (typeof _obj in tup_logistics_container))  then {
