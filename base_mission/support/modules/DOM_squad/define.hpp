...
class XD_LinkButtonBase {
	...
	colorBorder[] = {1, 1, 1, 0};
	borderSize = 0;
	soundEnter[] = {__UI_Sound_Path(onover),0.09,1};
	soundPush[] = {__UI_Sound_Path(new1),0.0,0};
	soundClick[] = {__UI_Sound_Path(onclick),0.07,1};
	soundEscape[] = {__UI_Sound_Path(onescape),0.09,1};
	x = 0.06; y = 0.11;
	w = 0.15; h = 0.1;
	text = "";
	action = "";
