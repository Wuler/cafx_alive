...
itemsRequiredToDisarm = ["ToolKit"];   //"MineDetector" or  for example
betterDisarmers = ["CAF_CBTENGINEER_AR", "B_soldier_exp_F", "B_engineer_F", "B_diver_exp_F", "B_recon_exp_F"]; // people who are better at disarming
