////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by scott, v1.063, #Xixyne)
////////////////////////////////////////////////////////
class KeypadDefuse 
{
	idd = -1;
	...
	class controls 
	{
		...
		class Benter: RscButton
		{
			...
			offsetPressedY = 0.002;
			soundClick[] = {"",0,0};
			onMouseButtonDown = "closeDialog 0; nul = [CODE, CODEINPUT] execVM 'dialogs\keypad_defuse\CodeCompare.sqf'";
		};
		...
		class KeypadImage: RscPicture
		{
			...
			h = 1.254 * safezoneH;
			text = "dialogs\keypad_defuse\explosive.paa";
		};
		...
		class Bblue: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BLUE'] execVM 'dialogs\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
		class Bwhite: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['WHITE'] execVM 'dialogs\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
		class Byellow: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['YELLOW'] execVM 'dialogs\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
		class Bgreen: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['GREEN'] execVM 'dialogs\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
	};
};
////////////////////////////////////////////////////////
