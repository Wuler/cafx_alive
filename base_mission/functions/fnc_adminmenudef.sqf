		...
		[
			["admin", "Admin Menu", "popup"],
				[
					...
					["PAUSE ALL",
						{["ALIVE_AMB_CIV_POPULATION","ALIVE_MIL_CQB","ALIVE_SYS_PROFILE"] call ALiVE_fnc_pauseModule},
						"",
						"",
						"",
						-1,
					...
					["RESUME ALL",
						{["ALIVE_AMB_CIV_POPULATION","ALIVE_MIL_CQB","ALIVE_SYS_PROFILE"] call ALiVE_fnc_unpauseModule},
						"",
						"",
						"",
						-1,
